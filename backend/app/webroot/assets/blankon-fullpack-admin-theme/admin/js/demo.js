...
$(document).ready(function(){
    ...
    //if ($.cookie('color_schemes')) {
        ...
        $('link#theme').attr('href', '../../../assets/admin/css/themes/blue.theme.css');
    //}
    ...
    //if ($.cookie('navbar_color')) {
		...
		$('.navbar-toolbar').attr('class', 'navbar navbar-toolbar navbar-primary');
    //}
